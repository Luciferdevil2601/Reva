...
const Body=z.object({jd_text:z.string().min(1),resume_text:z.string().min(1),model:z.enum(OPENROUTER_MODELS).optional(),user_id:z.string().optional(),email:z.string().email().optional()});
