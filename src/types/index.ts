...
export type AnalysisResult = { ats_score:number; breakdown:ScoreBreakdown; keywords_found:string[]; keywords_missing:string[]; quick_wins:string[]; improvement_tips:string[] };
